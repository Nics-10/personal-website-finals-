    ...
    <div class="container">
      <div class="hero-content">
        ...
        <div class="social-buttons">
          ...
          <a href="https://github.com" target="_blank" class="social-btn github" aria-label="GitHub">
            <svg width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
...
.hero-section {
  ...
  background: linear-gradient(135deg, var(--soft-white) 0%, #e8e8e8 50%, var(--soft-white) 100%);
  position: relative;
  overflow: hidden;
}

.dark-mode .hero-section {
  background: linear-gradient(135deg, var(--dark-bg) 0%, #252525 50%, var(--dark-bg) 100%);
}
